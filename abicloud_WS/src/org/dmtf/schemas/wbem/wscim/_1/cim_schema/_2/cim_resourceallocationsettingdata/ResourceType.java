...
public class ResourceType
{
    ...
    public final static int ResourceType_Memory = 4;

    // Resource Type processors numbers
    public final static int ResourceType_Processor = 3;

    // Resource Type hard disk
    public final static int ResourceType_HD = 17;
