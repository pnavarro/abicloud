...
public class ObjectFactory
{
    ...
    private final static QName _StartupSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "StartupSection");

    private final static QName _DiskSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "DiskSection");

    private final static QName _Section_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "Section");

    private final static QName _VirtualSystem_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "VirtualSystem");

    private final static QName _AnnotationSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "AnnotationSection");

    private final static QName _OperatingSystemSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "OperatingSystemSection");

    private final static QName _ResourceAllocationSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "ResourceAllocationSection");

    private final static QName _VirtualHardwareSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "VirtualHardwareSection");

    private final static QName _InstallSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "InstallSection");

    private final static QName _NetworkSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "NetworkSection");

    private final static QName _VirtualSystemCollection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "VirtualSystemCollection");

    private final static QName _Envelope_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "Envelope");

    private final static QName _EulaSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "EulaSection");

    private final static QName _DeploymentOptionSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "DeploymentOptionSection");

    private final static QName _Content_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "Content");

    private final static QName _ProductSection_QNAME =
        new QName("http://schemas.dmtf.org/ovf/envelope/1", "ProductSection");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes
     * for package: org.dmtf.schemas.ovf.envelope._1
     */
    ...
    {
        return new JAXBElement<VirtualSystemType>(_VirtualSystem_QNAME,
    ...
    {
        return new JAXBElement<AnnotationSectionType>(_AnnotationSection_QNAME,
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <} {@link ResourceAllocationSectionType }
     * {@code >}
     */
    ...
    public JAXBElement<ResourceAllocationSectionType> createResourceAllocationSection(
        ResourceAllocationSectionType value)
    {
        return new JAXBElement<ResourceAllocationSectionType>(_ResourceAllocationSection_QNAME,
    ...
    {
        return new JAXBElement<NetworkSectionType>(_NetworkSection_QNAME,
    ...
    public JAXBElement<VirtualSystemCollectionType> createVirtualSystemCollection(
        VirtualSystemCollectionType value)
    {
        return new JAXBElement<VirtualSystemCollectionType>(_VirtualSystemCollection_QNAME,
    ...
    public JAXBElement<DeploymentOptionSectionType> createDeploymentOptionSection(
        DeploymentOptionSectionType value)
    {
    ...
    public JAXBElement<EntityType> createContent(EntityType value)
    {
        return new JAXBElement<EntityType>(_Content_QNAME, EntityType.class, null, value);
    }
