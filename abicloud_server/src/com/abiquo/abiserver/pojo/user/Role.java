...
public class Role implements IPojo
{
    /* ------------- Public atributes ------------- */
    private int id;
    ...
    public IPojoHB toPojoHB()
    {
        ...
        roleHB.setIdRole(this.id);
        roleHB.setShortDescription(this.shortDescription);
        roleHB.setLargeDescription(this.largeDescription);
        roleHB.setSecurityLevel(this.securityLevel);
        return roleHB;
    }
}
