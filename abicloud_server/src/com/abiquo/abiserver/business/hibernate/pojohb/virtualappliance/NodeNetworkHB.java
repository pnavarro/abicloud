 ...
 *
 */
public class NodeNetworkHB extends NodeHB
{
	private static final long serialVersionUID = -5041253606886581430L;

	public IPojo toPojo()
	{
		NodeNetwork nodeNetwork = (NodeNetwork) super.toPojo();
