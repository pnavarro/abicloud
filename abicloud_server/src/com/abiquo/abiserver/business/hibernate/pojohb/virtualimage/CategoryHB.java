 ...
 */
public class CategoryHB implements java.io.Serializable, IPojoHB {
	...
	public IPojo toPojo()
	{
		...
		category.setIsErasable(this.isErasable == 1 ? true:false);
		category.setIsDefault(this.isDefault == 1 ? true:false);
