...
INSERT INTO `kinton`.`auth_clientresource_exception` (`id`,`idResource`,`idUser`) VALUES 
 (1,4,2);
...
CREATE TABLE  `kinton`.`category` (
  ...
  `erasable` int(1) unsigned NOT NULL default '1',
...
INSERT INTO `kinton`.`category` (`idCategory`,`name`,`erasable`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (1,'Others',0,1,'2008-11-20 13:28:42',NULL,NULL),
 (2,'Database servers',1,1,'2008-11-20 13:28:42',NULL,NULL),
 (3,'Operating Systems',1,1,'2008-11-20 13:28:42',NULL,NULL),
 (4,'Applications servers',1,1,'2008-11-20 13:28:42',NULL,NULL),
 (5,'Web servers',1,1,'2008-11-20 13:28:42',NULL,NULL),
 (6,'Load Balancing servers',1,1,'2008-11-20 13:28:42',NULL,NULL);
...
INSERT INTO `kinton`.`datacenter` (`idDataCenter`,`name`,`situation`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (2,'myDatacenter','Madrid',1,'2008-11-20 13:32:38',1,'2008-11-20 13:28:42'),
...
INSERT INTO `kinton`.`dns` (`idDns`,`idNetworkModule`,`idPhysicalMachine`,`dns`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (1,1,1,'192.168.200.2',1,'2009-01-20 10:27:40',NULL,NULL),
 (1,2,1,'192.168.1.1',1,'2009-01-20 10:27:40',NULL,NULL),
 (2,1,1,'192.168.200.3',1,'2009-01-20 10:27:40',NULL,NULL);
...
INSERT INTO `kinton`.`hypervisor` (`id`,`description`,`idType`,`idPhysicalMachine`,`ip`,`port`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (1,'vBox',1,1,'192.168.1.34',18083,1,'2008-11-20 15:29:05',NULL,NULL),
...
INSERT INTO `kinton`.`networkmodule` (`idNetworkModule`,`idPhysicalMachine`,`dhcp`,`ip`,`gateway`,`bw`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModifcationDate`,`subnetMask`) VALUES 
 (1,1,0,'192.168.200.254','192.168.200.1','50.00',1,'2009-01-20 10:27:40',NULL,NULL,'255.255.255.0'),
 (2,1,1,'','','100.00',1,'2009-01-20 10:27:40',NULL,NULL,'');
...
INSERT INTO `kinton`.`physicalmachine` (`idPhysicalMachine`,`idRack`,`idDataCenter`,`name`,`description`,`ram`,`cpu`,`hd`,`host_SO`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`,`ramUsed`,`cpuUsed`,`hdUsed`) VALUES 
 (1,3,2,'Barcelona','Barcelona',1024,'32.00',100,2,1,'2008-11-20 15:29:05',1,'2009-01-20 10:27:40',-1024,'2.00',-2),
 ...
 (13,9,2,'MyMachine','MyMachine',1024,'2.00',100,2,1,'2008-11-20 15:29:05',1,'2008-11-20 15:29:05',256,'2.00',2);
...
INSERT INTO `kinton`.`rack` (`idRack`,`idDataCenter`,`name`,`shortDescription`,`largeDescription`,`idUserCreataion`,`creatioNDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (1,3,'Rack 1','Rack 1','Este es el Rack 1',1,'2008-10-29 15:42:16',1,'2008-11-20 13:28:42'),
...
INSERT INTO `kinton`.`user` (`idUser`,`idRole`,`user`,`name`,`surname`,`description`,`email`,`locale`,`password`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`,`active`) VALUES 
 (1,2,'root','Administrador','Principal','Main administrator','root@root.com','es_ES','xabiquo',1,'2008-10-20 00:00:00',1,'2009-01-20 13:52:36',1),
 ...
 (111,1,'dummy106','Dummy 106','Dummy Dummy106','Dummy user ','dummy@dummy,du106','es_ES','dummy',1,'2008-12-16 14:55:23',1,'2008-12-24 11:15:53',1),
...
INSERT INTO `kinton`.`virtualapp` (`idVirtualApp`,`name`,`public`,`idState`,`high_disponibility`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`) VALUES 
 (1,'Test',0,1,0,1,'2009-01-23 12:46:37',NULL,NULL),
 (2,'Test 2',0,6,0,1,'2009-01-26 16:47:38',1,'2009-01-26 16:47:45');
...
INSERT INTO `kinton`.`virtualimage` (`idImage`,`name`,`description`,`pathName`,`idSO`,`hd_required`,`ram_required`,`cpu_required`,`idCategory`,`treaty`,`idRepository`,`idIcon`,`deleted`,`idUserCreation`,`creationDate`,`idUser_lastModification`,`lastModificationDate`,`imageType`) VALUES 
 (1,'Ubuntu','Ubuntu','/opt/vm_repository/ubuntu-8.10-x86.vdi',2,2,256,'2.00',5,0,1,1,0,1,'2008-11-20 13:28:42',1,'2009-01-23 13:45:42',1),
 (2,'Xubuntu web server','Xubuntu','/opt/vm_repository/ubuntu-8.04-x86.vdi',2,2,256,'9999.99',3,0,1,2,0,1,'2008-11-20 13:28:42',1,'2009-01-26 18:58:16',1),
 (3,'MySql Server','Debian + Mysql server','/opt/vm_repository/Debian - MySQL database server.vdi',2,2,256,'2.00',6,0,1,3,0,1,'2008-11-20 13:28:42',1,'2009-01-21 17:24:13',1),
 (4,'abiquo MW','MW in a box','/opt/vm_repository/AbiquoMW.vdi',2,2,256,'2.00',1,0,1,4,0,1,'2008-11-20 13:28:42',1,'2009-01-26 18:51:52',1),
 (5,'Tomcat','Debian + Tomcat','/opt/vm_repository/Debian - Tomcat app server.vdi',2,2,256,'2.00',3,0,1,5,0,1,'2008-11-20 13:28:42',1,'2009-01-21 17:28:54',1),
 (6,'test','test','/opt/vm_repository/WindowsXP.vdi',1,2,256,'2.00',3,0,1,6,0,1,'2008-11-20 13:28:42',1,'2009-01-26 18:58:13',1);
...
INSERT INTO `kinton`.`virtualmachine` (`idVM`,`idHypervisor`,`idImage`,`UUID`,`name`,`description`,`ram`,`cpu`,`hd`,`vdrpPort`,`vdrpIP`,`idState`,`high_disponibility`) VALUES 
 (1,1,2,'96b1b785-2635-47ed-818e-f35c3828','XUbuntu','XUbuntu VM',1024,'9999.99',0,3389,'192.168.1.44',2,0),
 (3,3,4,'bc878d24-0d24-4363-8a0d-81530a11','abiquo MW','abiquo MW VM',2048,'2.00',300,3389,'192.168.1.34',5,0),
 (4,1,5,'ce164a45-5e59-43cb-bf1a-7eb4d14e','Tomcat','Tomcat VM',1024,'2.00',256,3389,'192.168.1.37',1,0),
 (5,1,1,'ce164a45-5e59-43cb-bf1a-7eb4d14e','ubuntu','ubuntu',1024,'9999.99',256,3389,'abiquo.homelinux.net',5,0),
 (7,1,3,'8e31b7ab-2c89-496f-8abd-3b5e7d5c','Mysql server','MySql server',1024,'9999.99',1,3389,'192.168.1.35',6,0),
 (8,7,4,'0328479c-aac3-4b09-b15e-445ee6012184','MyMachine to abiquo MW','MW in a box',256,'2.00',2,3389,'localhost',5,0);
