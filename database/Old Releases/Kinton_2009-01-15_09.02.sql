...
INSERT INTO `kinton`.`category` VALUES  (1,'Operating Systems',1,'2008-11-20 13:28:42',NULL,NULL),
...
INSERT INTO `kinton`.`dns` VALUES  (1,1,1,'192.168.200.3',1,'2009-01-12 15:50:11',NULL,NULL),
 (1,2,1,'192.168.1.1',1,'2009-01-12 15:50:11',NULL,NULL),
 (2,1,1,'192.168.200.2',1,'2009-01-12 15:50:11',NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `kinton`.`hypervisor` VALUES  (1,'vBox','vBox',1,1,'192.168.1.34',18083),
 (3,'vBox','vBox',1,3,'192.168.1.36',18083),
 (4,'vBox','vBox',1,6,'192.168.1.37',18083),
 (5,'vBox','vBox',1,11,'192.168.1.44',18083),
 (6,'vBox','vBox',1,12,'192.168.1.49',18083),
 (7,'vBox','vBox',1,13,'localhost',18083);
UNLOCK TABLES;
...
INSERT INTO `kinton`.`hypervisortype` VALUES  (1,'vBox');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`icon` VALUES  (1,'http://swik.net/swikIcons/img-542-96x96.png','Ubuntu'),
...
INSERT INTO `kinton`.`networkmodule` VALUES  (1,1,0,'192.168.200.254','192.168.200.1','50.00',1,'2009-01-12 15:50:11',NULL,NULL,'255.255.255.0'),
 (2,1,1,'','','100.00',1,'2009-01-12 15:50:11',NULL,NULL,'');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`physicalmachine` VALUES  (1,3,2,'Barcelona','Barcelona',1024,'2.00',100,2,1,'2008-11-20 15:29:05',1,'2009-01-12 15:50:11',-1024,'-2.00',-2),
 ...
 (10,1,2,'A Coru̱a','A Coru̱a',1024,'2.00',100,2,1,'2008-11-20 15:29:05',1,'2008-12-18 21:01:04',0,'0.00',0),
 (11,1,2,'Cornella','Cornella',1024,'2.00',100,2,1,'2008-11-20 15:29:05',1,'2008-11-20 15:29:05',-1024,'-2.00',-2),
...
INSERT INTO `kinton`.`repository` VALUES  (1,'Main Repository','/opt/vm_repository',1,'2008-11-20 13:28:42',1,'2008-11-20 13:28:42');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`session` VALUES  (11,'root','1232010903542','2009-01-15 10:15:03');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`user` VALUES  (1,2,'root','Administrador','Principal','Main administrator','root@root.com','es_ES','xabiquo',1,'2008-10-20 00:00:00',1,'2008-12-19 18:48:46',1),
...
INSERT INTO `kinton`.`virtualimage` VALUES  (1,'Ubuntu','Ubuntu','/opt/vm_repository/ubuntu-8.10-x86.vdi',2,2,256,'2.00',1,0,1,1,0,1,'2008-11-20 13:28:42',1,'2008-11-28 12:33:21',1),
 (2,'Xubuntu web server','Xubuntu','/opt/vm_repository/ubuntu-8.04-x86.vdi',2,2,256,'2.00',4,0,1,2,0,1,'2008-11-20 13:28:42',1,'2009-01-14 16:10:51',1),
 ...
 (4,'abiquo MW','MW in a box','/opt/vm_repository/AbiquoMW.vdi',2,2,256,'2.00',1,0,1,4,0,1,'2008-11-20 13:28:42',1,'2009-01-12 09:32:03',1),
...
INSERT INTO `kinton`.`virtualmachine` VALUES  (1,5,2,'96b1b785-2635-47ed-818e-f35c3828','XUbuntu','XUbuntu VM',1024,'2.00',2,3389,'192.168.1.44',5,0),
 (3,3,4,'bc878d24-0d24-4363-8a0d-81530a11','abiquo MW','abiquo MW VM',2048,'2.00',300,3389,'192.168.1.34',5,0),
 (4,4,5,'ce164a45-5e59-43cb-bf1a-7eb4d14e','Tomcat','Tomcat VM',1024,'2.60',256,3389,'192.168.1.37',5,0),
 (5,6,1,'ce164a45-5e59-43cb-bf1a-7eb4d14e','ubuntu','ubuntu',1024,'2.00',256,3389,'abiquo.homelinux.net',5,0),
 (7,1,3,'8e31b7ab-2c89-496f-8abd-3b5e7d5c','Mysql server','MySql server',1024,'2.00',2,3389,'192.168.1.35',5,0);
UNLOCK TABLES;
