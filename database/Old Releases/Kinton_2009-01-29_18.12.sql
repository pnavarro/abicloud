...
INSERT INTO `kinton`.`hypervisor` VALUES  (1,'vBox',1,1,'192.168.1.34',18083,1,'2008-11-20 15:29:05',NULL,NULL),
 ...
 (7,'vBox',1,13,'192.168.1.34',18083,1,'2008-11-20 15:29:05',NULL,NULL);
UNLOCK TABLES;
...
CREATE TABLE  `kinton`.`nodes` (
  ...
  KEY `Nodes_FK5` (`idVM`),
  CONSTRAINT `Nodes_FK2` FOREIGN KEY (`idVM`) REFERENCES `virtualmachine` (`idVM`) ON DELETE SET NULL,
...
INSERT INTO `kinton`.`nodes` VALUES  (2,10,-387,-270,26,4),
 (2,11,-193,-247,NULL,4);
UNLOCK TABLES;
...
INSERT INTO `kinton`.`physicalmachine` VALUES  (1,3,2,'Barcelona','Barcelona',1024,'32.00',100,2,1,'2008-11-20 15:29:05',1,'2009-01-28 11:55:58',-1024,'2.00',-2),
 ...
 (13,9,2,'MyMachine','MyMachine',9999,'9.00',9999,2,1,'2008-11-20 15:29:05',1,'2008-11-20 15:29:05',768,'0.00',0);
UNLOCK TABLES;
...
INSERT INTO `kinton`.`session` VALUES  (3,'root','1233248278528','2009-01-29 18:17:31');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`virtualapp` VALUES  (2,'1',0,1,0,1,'2009-01-29 17:58:06',1,'2009-01-29 18:07:13');
UNLOCK TABLES;
...
INSERT INTO `kinton`.`virtualimage` VALUES  (1,'Ubuntu','Ubuntu','/opt/vm_repository/ubuntu-8.10-x86.vdi',2,2,256,'2.00',5,0,1,1,0,1,'2008-11-20 13:28:42',1,'2009-01-23 13:45:42',1),
 (2,'Xubuntu web server','Xubuntu','/opt/vm_repository/opt/vm_repository/ubuntu-8.04-x86.vdi',2,0,256,'32.00',1,0,1,2,0,1,'2008-11-20 13:28:42',1,'2009-01-28 10:51:26',1),
...
INSERT INTO `kinton`.`virtualmachine` VALUES  (1,1,2,'96b1b785-2635-47ed-818e-f35c3828','XUbuntu','XUbuntu VM',1024,'9999.99',0,3389,'192.168.1.44',5,0),
 ...
 (18,7,3,'1bcd8a20-9e17-48a2-aa3d-345f80253f58','MyMachine to MySql Server','Debian + Mysql server',256,'2.00',2,3389,'192.168.1.34',5,0),
 (19,7,4,'93d7ed34-c064-4c3e-916c-8feba081fedf','08626056-9363-4880-b124-9c82bdfa4903','MW in a box',256,'2.00',0,3390,'192.168.1.34',1,0),
 (20,7,4,'54644168-2c04-4018-bee4-91c71a22f051','2f32d221-2a97-4141-972b-57fcff91b092','MW in a box',256,'2.00',0,3391,'192.168.1.34',1,0),
 (26,7,4,'b7dd9496-bdc9-4169-8c94-640a933b9a85','ebf35bb1-8b67-4448-bc70-1885aa3222ca','MW in a box',256,'2.00',0,3392,'192.168.1.34',1,0);
UNLOCK TABLES;
