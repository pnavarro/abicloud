...
public class EventresourceHandler extends ResourceHandler
{
    ...
    public static final String resourceURI =
        "http://abiquo.com/abicloud/vsm/event.xsd/eventService/eventResource";
    ...
    {
        // TODO: For subscribe:
        // Call EventSupport.subscribe() & save the UUID returned (use ContextListener to detect
        ...
        // TODO Save the subscribe message to DB
        // TODO Recollect the eventType, VirtualSystemAddress, VirtualSystemID, notifyTO
        // TODO The virtualSystemAddress will be used to connect with the hypervisor
